...
questions_list.append(Question('Название нашей группы в WhatsApp', 'Хакеры 882', 'Харакиры 882', 'Хехакеры 228', '882 ырекаХ'))
...
def next_question():
    ...
    q = questions_list[cur_question] # взяли вопрос # q = questions_list[randint(0, len(questions_list) - 1)]
    ask(q) # спросили # ask(questions_list[randint(0, len(questions_list) - 1)])
