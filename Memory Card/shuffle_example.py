...
rbtn_1.setObjectName("[ 1 ] ") # даю имена каждому 
rbtn_2.setObjectName("[ 2 ] ") # радиобатону согласно 
rbtn_3.setObjectName("[ 3 ] ") # его номеру
rbtn_4.setObjectName("[ 4 ] ")
def ask(question: Question):
    ...
    answers[0].setText(answers[0].objectName() + "[ п ] " + question.right_answer) # вывожу после перемешивания 
    answers[1].setText(answers[1].objectName() + "[ н1 ] " + question.wrong1)      # название объектов согласно 
    answers[2].setText(answers[2].objectName() + "[ н2 ] " + question.wrong2)      # его индексу. Отметив правильный
    answers[3].setText(answers[3].objectName() + "[ н3 ] " + question.wrong3)      # и неправильные варианты
    lb_Question.setText(question.question) # вопрос
    lb_Correct.setText(question.right_answer) # ответ 
...
def next_question():
    ...
    ask(questions_list[window.cur_question]) # спросили
